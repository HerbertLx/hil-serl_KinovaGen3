...
# --- 导入 KinovaManager (替代原本复杂的底层 API 调用) ---
try:
    from kinova_manage import KinovaManager
    print("✅ 成功导入 KinovaManager")
except ImportError as e:
    print(f"❌ 无法导入 KinovaManager: {e}")
...
class DefaultEnvConfig:
    ...
    # --- 网络与硬件连接 ---
    SERVER_URL: str = "http://127.0.0.1:5000/"  # 机器人控制服务器的地址

    SERVER_IP: str = "192.168.8.10"

    REALSENSE_CAMERAS: Dict = {                  # 摄像头配置
    ...
    ACTION_SCALE = np.zeros((3,)) # 动作空间缩放
